...
class IndexTest extends CrawlerTestCase
{
    public function testPreview()
    {
        ...
        $this->assertStringContainsString('z&auml;<span style="background-color:#FFEBD1; color:black;">hlt</span>', $model->preview('hlt', 150));
    ...
    public function testSpecialCharsHighlightBug()
    {
        ...
        $this->assertStringContainsString('<span style="background-color:#FFEBD1; color:black;">Ph&ouml;be</span>', $index->preview('ph&ouml;be'));
    }
}
